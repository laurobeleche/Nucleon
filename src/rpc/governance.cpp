...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in neon.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("neon.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Nucleon features */
    { "neon",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "neon",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "neon",               "gobject",                &gobject,                true,  {} },
    { "neon",               "voteraw",                &voteraw,                true,  {} },
