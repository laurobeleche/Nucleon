...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_100000000);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Nucleon address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "neon",               "masternode",             &masternode,             true,  {} },
    { "neon",               "masternodelist",         &masternodelist,         true,  {} },
    { "neon",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "neon",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "neon",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "neon",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
