...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 50 * COIN;
//! -mintxfee default
...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_100000000, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000NEON output and keys which can be used for the Masternode
