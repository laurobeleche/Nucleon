...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Nucleon related functionality
...
/*
    ...
    allow endless transaction that would bloat Nucleon and make it unusable. To
