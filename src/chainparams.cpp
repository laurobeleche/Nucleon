...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("neondot.io", "dnsseed.neondot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("MealwormsBiz.io", "dnsseed.MealwormsBiz.io"));

        // Nucleon addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Nucleon script addresses start with '7'
