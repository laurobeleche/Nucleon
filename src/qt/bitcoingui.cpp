...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nucleon address"));
    ...
    websiteAction = new QAction(QIcon(":/icons/" + theme + "/website"), tr("&Website"), this);
    websiteAction->setStatusTip(tr("Nucleon Website"));
    websiteAction->setToolTip(websiteAction->statusTip());
    websiteAction->setCheckable(true);
#ifdef Q_OS_MAC
    websiteAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_6));
#else
    websiteAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
#endif
    ...
    connect(websiteAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(websiteAction, SIGNAL(triggered()), this, SLOT(gotoWebsite()));
#endif // ENABLE_WALLET
    ...
    aboutAction->setStatusTip(tr("Show information about Nucleon Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nucleon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nucleon addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Nucleon command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    websiteAction->setEnabled(enabled);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nucleon network", "", count));
    } else {
...
{
    QString strTitle = tr("Nucleon Core"); // default title
