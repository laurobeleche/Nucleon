...
All the Nucleon in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NEON, 0.1 NEON, 1 NEON and 10 NEON -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://MealwormsBiz.atlassian.net/wiki/display/DOC/PrivateSend\">https://MealwormsBiz.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
