/* src/config/neon-config.h.  Generated from neon-config.h.in by configure.  */
/* src/config/neon-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Nucleon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Nucleon Core"
...
#define PACKAGE_STRING "Nucleon Core 2.2.0"
