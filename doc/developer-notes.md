...
Nucleon Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Nucleon Core, where everyone uses
...
pay attention to for reviewers of Nucleon Core code.

General Nucleon Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Nucleon Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Nucleon Core so that they can be integrated
