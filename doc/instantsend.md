...
This mechanism has been integrated into Bitcore-Node-Nucleon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MealwormsBiz/insight-api-neon#web-socket-api](https://github.com/MealwormsBiz/insight-api-neon#web-socket-api)
* API: [https://github.com/MealwormsBiz/insight-api-neon#instantsend-transactions](https://github.com/MealwormsBiz/insight-api-neon#instantsend-transactions)
...
By default, the Nucleon Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nucleon Core daemon:
